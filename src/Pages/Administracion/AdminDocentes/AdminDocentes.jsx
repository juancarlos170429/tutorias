...
const AdminDocentes = () => {
    ...
    return (
        <div>
            <ViewAdmin nombrePage={"Docentes"}>
                <h5>Lista de docentes:</h5>
                <div className="AD_wrapper_table">
                <MaterialTable
                            fixedHeader={true}
                            columns={columnas} 
                            data={data} 
                ...
                <button onClick={()=>abrirCerrarModalInsertar()} className="AD_agregar"> <b>Agregar docente</b></button> 
                <div class="input-group">
                    <input type="file"  className="form-control" id="inputGroupFile04" aria-describedby="inputGroupFileAddon04" aria-label="Upload"
                        onChange={(e)=>{
                            ...
                            readExcel(file);}}
                       />
                    <button className="AD_importar" type="button" id="inputGroupFileAddon04"onClick={()=>peticionPostExcel()}>Importar</button>
                </div>
                <Modal isOpen={modalInsertar} size="lg">
                    ...
                    <ModalFooter>
                    <button className="AD_btnopcions" onClick={()=>peticionPost()} >Insertar</button>{""}
                    <button className="AD_btnopcions" onClick={()=>abrirCerrarModalInsertar()}>Cancelar</button>
                    </ModalFooter>
                </Modal>
                <Modal isOpen={modalActualizar} size="lg">
                    <ModalHeader>Actualizar datos de tutorado</ModalHeader>
                    <ModalBody>
                    <div className="form-group">
                        <Row>
                            <Col>
                    ...
                    <ModalFooter>
                    <button className="AD_btnopcions" onClick={()=>peticionPut()} >Guardar</button>{""}
                    <button className="AD_btnopcions" onClick={()=>abrirCerrarModalActualizar()}>Cancelar</button>
                    </ModalFooter>
                </Modal>
